            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="well well-sm">
                            <span style="font-size: 1em;" class="label label-success">Create Position &nbsp; <i class="fa fa-pencil" aria-hidden="true"></i>
                            </span>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a class="btn btn-danger" href="{{URL('positions')}}">Back</a>
                            </div>
                        </div>
