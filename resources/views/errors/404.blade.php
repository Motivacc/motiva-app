...
<div class="error404page">
    <div class="newcharacter404">
        ...
        <div class="laptop404">
           <p style="position:absolute; top:25%; left: 35%;">Page Not Found</p>
            <p style="position:absolute; top:32%; left: 34%; z-index: 999;">We Working On it!</p>
            <img style="position:absolute; top:33%; left: 41%; " height="80" width="80" src="http://web.share.to/img/mac-logo.png" alt="logo">
            <a href="{{URL('/')}}" style="background-color: #c0392b; color:#fff; text-decoration: none; padding: 7px 10px; position: absolute; top:70%; left:35%; box-shadow: 2px 2px 1px #7f8c8d;">Return to Apply</a>
        </div>
    </div>
</div>
</body>
